        ...
        <form method="POST" action="http://localhost/ts_immo/Proprietaire/addProprietaire" >
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="sexe" name="sexe" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Date de Naissance</label>
                <input type="date" class="form-control" id="date_naissance"  name="date_naissance" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Addresse</label>
                <input type="text"  class="form-control" id="addresse" name="addresse" aria-describedby="emailHelp">
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text"  class="form-control" id="piece_identite" name="piece_identite" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">date_ajout</label>
                <input type="date"  class="form-control" id="date_ajout" name="date_ajout" aria-describedby="emailHelp">
              </div>
              <input type="submit" class="button btn btn-primary" value="Ajouter" name="add">
          </form>
      </div>
      <div class="col-6">
</body>
